    ...
    if (options.modules !== 'all') {
      ...
      if (useModular) {
        ...
        if (projectType === 'fullstack') {
          selectedModules = { ...selectedModules, ...configExamples.fullStack.modules };
        } else if (projectType === 'web' || projectType === 'api') {
          selectedModules = { ...selectedModules, ...configExamples.frontend.modules };
        } else {
          selectedModules = { ...selectedModules, ...configExamples.minimal.modules };
        }
      }
    } else {
      // Install all modules
