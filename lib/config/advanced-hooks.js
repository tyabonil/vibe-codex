...
const advancedHooks = {
  ...
  "ai-review": {
    name: "AI Code Review",
    description: "Get AI-powered code reviews before push",
    hooks: [
      {
        file: "phone-a-friend/pre-push-ai-review.sh",
        type: "pre-push",
        description: "AI review of code changes before push",
        requiresConfig: true,
        configKey: "phoneAFriend",
      },
    ],
  },
};
