...
describe('Hooks Integration with NPM Package', () => {
  ...
  describe('Package Structure', () => {
    ...
    test('should have issue progress tracker hook', () => {
      const hookPath = path.join(originalCwd, 'hooks/issue-progress-tracker.sh');
  ...
  describe('Hooks Functionality', () => {
    test('should be callable from npm package root', () => {
      const issueHookPath = path.join(originalCwd, 'hooks/issue-progress-tracker.sh');
  ...
  describe('Rule Engine Integration', () => {
    ...
    test('should be testable independently', () => {
      ...
      const result = runScript('npm test -- tests/issue-progress-tracker.test.js', originalCwd);
    ...
    test('should have valid syntax and structure', () => {
      ...
      const issueTestPath = path.join(originalCwd, 'tests/issue-progress-tracker.test.js');
      const prTestPath = path.join(originalCwd, 'tests/pr-review-check.test.js');
